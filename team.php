...
<?php else : ?>
    ...
    <div class="container center">
        <div class="card z-depth-0 radius-card" style="padding-bottom: 30px;">
            ...
            <h3 class="center"><?php echo $team['name']; ?></h3>
            <h5 class="center">Founded in <?php echo $team['founded']; ?></h5>
            <h5 class="center">Location: <?php echo $team['city']; ?></h5>
            <h5 class="center">Arena: <?php echo $team['stadium']; ?></h5>
            <h5 class="center">Number of rings: <?php echo $team['titles']; ?></h5>
            <h5 class="center">Manager: <?php echo $team['manager']; ?></h5>
        </div>
    </div>
                    ...
                    <div class="col s12 m6 l4 xl3">
                        <div class="card z-depth-0 radius-card">
                            ...
                            <div class="card-action right-align radius-card">
                                <a href="player.php?id=<?php echo $player['id']; ?>" class="brown-text text-darken-2">
                                    More Info
                                </a>
                            </div>
                        </div>
